...
static void applyPendingBrowserLogin(void)
{
    ...
    NSString *source = [NSString
        stringWithFormat:@"const auth=globalThis.unbound.metro.findByProps('getToken','setToken')??globalThis.unbound.metro.findByProps('getAnalyticsToken','setToken');if(!auth)throw new Error('Discord authentication store unavailable');auth.setToken(%@);",
                         tokenJSON];
